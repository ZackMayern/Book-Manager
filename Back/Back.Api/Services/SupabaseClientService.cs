...
namespace Back.Services
{
    public sealed class SupabaseClientService(SupabaseClient supabaseClient, ILoggerService logger) : ISupabaseClientService
    {
            ...
            where T : BaseModel, new()
        {
            ...
            {
                _logger.LogError(ex, $"[ERR]: Validation failed - {ex.Message}");
                throw;
            }
            ...
            {
                _logger.LogError(ex, $"[ERR]: Create operation failed - {ex.Message}");
                throw;
            }
        }
            ...
            where T : BaseModel, new()
        {
            ...
            {
                _logger.LogError(ex, $"[ERR]: Update operation failed - {ex.Message}");
                throw;
            }
        }
            ...
            where T : BaseModel, new()
        {
            ...
            {
                _logger.LogError(ex, $"[ERR]: Delete operation failed - {ex.Message}");
                throw;
            }
        }
